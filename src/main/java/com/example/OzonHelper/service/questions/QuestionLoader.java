...
public class QuestionLoader {
    ...
    public List<QuestionDto> loadAllQuestions(OzonClient client, LocalDateTime from, LocalDateTime to, QuestionStatus status) throws IOException, InterruptedException {
